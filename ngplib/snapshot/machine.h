 ...
 *
 * $Id: machine.h,v 1.15 2006-12-22 12:08:03 daniel Exp $
 *
 */
...
// accesses the high resp low 32 bits of a int64
#if 0
#define HIGH(i64) (((const uint32*)(&i64))[0])
#define LOW(i64)  (((const uint32*)(&i64))[1])
#define SET(i64, high, low)                     \
do{                                             \
   ((uint32*)(&i64))[0] = high;                 \
   ((uint32*)(&i64))[1] = low;                  \
} while(0)
